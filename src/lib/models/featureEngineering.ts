...
/**
 * @param histSnapshots - ordered [1 day ago, 2 days ago, 3 days ago, 4 days ago, 5 days ago]
 */
export function buildFeatureVector(
  ...
  const precipLag1 = s1 ? clamp(s1.precip_intensity) : 0;
...
export const FEATURE_NAMES: (keyof FeatureVector)[] = [
  ...
  'days_high_pollen_last5', 'precip_lag1',
  'humidity_norm', 'wind_norm', 'temp_norm',
  'grass_x_humidity', 'grass_x_wind',
...
export const FEATURE_DISPLAY_NAMES: Record<keyof FeatureVector, string> = {
  ...
  days_high_pollen_last5: 'Sustained high pollen (5 days)',
  precip_lag1: 'Rain yesterday',
  humidity_norm: 'Humidity',
  wind_norm: 'Wind',
